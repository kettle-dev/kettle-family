...
- TAG: [v1.2.96][1.2.96t]
- COVERAGE: 93.49% -- 6235/6669 lines in 35 files
...
- TAG: [v1.2.77][1.2.77t]
- COVERAGE: 93.33% -- 5568/5966 lines in 33 files
- BRANCH COVERAGE: 76.69% -- 2290/2986 branches in 33 files
- 30.69% documented
...
- TAG: [v1.2.76][1.2.76t]
- COVERAGE: 93.32% -- 5558/5956 lines in 33 files
- BRANCH COVERAGE: 76.76% -- 2286/2978 branches in 33 files
- 30.69% documented
...
- TAG: [v1.2.75][1.2.75t]
- COVERAGE: 93.31% -- 5553/5951 lines in 33 files
- BRANCH COVERAGE: 76.70% -- 2281/2974 branches in 33 files
- 30.50% documented
...
- TAG: [v1.2.72][1.2.72t]
- COVERAGE: 93.32% -- 5535/5931 lines in 33 files
- BRANCH COVERAGE: 76.73% -- 2275/2965 branches in 33 files
- 30.50% documented
...
- TAG: [v1.2.59][1.2.59t]
- COVERAGE: 93.52% -- 5367/5739 lines in 33 files
- BRANCH COVERAGE: 76.27% -- 2173/2849 branches in 33 files
- 29.78% documented
...
- TAG: [v1.2.55][1.2.55t]
- COVERAGE: 93.58% -- 5278/5640 lines in 33 files
- BRANCH COVERAGE: 76.23% -- 2123/2785 branches in 33 files
- 29.86% documented
...
- TAG: [v1.2.41][1.2.41t]
- COVERAGE: 93.55% -- 5020/5366 lines in 32 files
- BRANCH COVERAGE: 76.05% -- 2010/2643 branches in 32 files
- 29.81% documented
...
- TAG: [v1.2.40][1.2.40t]
- COVERAGE: 93.62% -- 5007/5348 lines in 32 files
- BRANCH COVERAGE: 76.09% -- 2002/2631 branches in 32 files
- 29.81% documented
...
- TAG: [v1.2.38][1.2.38t]
- COVERAGE: 93.63% -- 5015/5356 lines in 32 files
- BRANCH COVERAGE: 76.07% -- 2000/2629 branches in 32 files
- 29.81% documented
...
- TAG: [v1.2.33][1.2.33t]
- COVERAGE: 93.70% -- 4997/5333 lines in 32 files
- BRANCH COVERAGE: 76.04% -- 1990/2617 branches in 32 files
- 29.61% documented
...
- TAG: [v1.2.27][1.2.27t]
- COVERAGE: 93.95% -- 4720/5024 lines in 31 files
- BRANCH COVERAGE: 76.57% -- 1853/2420 branches in 31 files
- 29.31% documented
...
- TAG: [v1.2.26][1.2.26t]
- COVERAGE: 93.94% -- 4701/5004 lines in 31 files
- BRANCH COVERAGE: 76.58% -- 1847/2412 branches in 31 files
- 29.31% documented
...
- TAG: [v1.2.25][1.2.25t]
- COVERAGE: 93.94% -- 4698/5001 lines in 31 files
- BRANCH COVERAGE: 76.54% -- 1843/2408 branches in 31 files
- 29.31% documented
...
[Unreleased]: https://github.com/kettle-dev/kettle-family/compare/v1.2.96...HEAD
...
[1.2.76t]: https://github.com/kettle-dev/kettle-family/releases/tag/v1.2.76
[1.2.75]: https://github.com/kettle-dev/kettle-family/compare/v1.2.74...v1.2.75
[1.2.75t]: https://github.com/kettle-dev/kettle-family/releases/tag/v1.2.75
...
[1.2.40t]: https://github.com/kettle-dev/kettle-family/releases/tag/v1.2.40
...
[1.2.26t]: https://github.com/kettle-dev/kettle-family/releases/tag/v1.2.26
[1.2.25]: https://github.com/kettle-dev/kettle-family/compare/v1.2.24...v1.2.25
[1.2.25t]: https://github.com/kettle-dev/kettle-family/releases/tag/v1.2.25
