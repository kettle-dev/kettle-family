...
# kettle-family Rakefile v7.1.23 - 2026-09-07
...
# rake install                                # Build and install kettle-family-1.0.0.gem in...
# rake install:local                          # Build and install kettle-family-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template kettle-family against itse...
