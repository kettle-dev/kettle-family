...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency("kettle-changelog", "~> 1.0", ">= 1.0.6")             # ruby >= 4.0.0, release-state and family changelog commands
  spec.add_dependency("kettle-dev", ">= 3.0.18", "< 4.0.0")                 # ruby >= 3.2.0
