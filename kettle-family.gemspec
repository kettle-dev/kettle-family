...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency("kettle-dev", "~> 2.2", ">= 2.2.10")     # ruby >= 3.2.0
  ...
  # The 'git' gem is optional; kettle-family falls back to shelling out to `git` if it is not present.
